      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            <div className="rounded-lg border border-dashed p-8 text-center space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Format: nume, prenume, cnp, data_nasterii, clasa, nume_parinte, prenume_parinte, email_parinte, telefon_parinte
              </p>
            ...
            <div className="rounded-lg bg-muted p-3 text-xs text-muted-foreground space-y-1">
              ...
              <code>Ionescu,Maria,1234567890123,2012-03-15,7A,Ionescu,Dan,dan@gmail.com,0722111222</code>
            </div>
          </div>
        )}
        ...
        {phase === "preview" && (
          <div className="space-y-4">
            ...
            <div className="rounded-xl border bg-white overflow-hidden max-h-64 overflow-y-auto">
              <Table>
                <TableHeader>
